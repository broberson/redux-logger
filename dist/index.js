...
/***/ function(module, exports) {
	...
	var timer = exports.timer = typeof performance !== "undefined" && typeof performance.now === "function" ? performance : Date;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function printBuffer(buffer, options) {
	  ...
	  buffer.forEach(function (logEntry, key) {
	    ...
	    var title = 'action @ ' + (timestamp ? formattedTime : '') + ' ' + formattedAction.type.toString() + ' ' + (duration ? '(in ' + took.toFixed(2) + ' ms)' : '');
